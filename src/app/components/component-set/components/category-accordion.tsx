...
/* Height of your sticky top navbar in px. Adjust this to match the real
   ...
   being partially hidden behind it. */
  ...
  return (
    <div
      ...
      style={{
        ...
        background: "#FFFFFF",
        boxShadow: isOpen ? "0 20px 50px rgba(10,20,50,0.08)" : "none",
          ...
          <div className="px-7 pb-7">
            {cat.items.length === 0 ? (
              ...
              >
                ...
                >
                  {cat.name} components are documented internally but haven't
                  been published to this case study yet.
                </p>
              </div>
            ) : (
              <div
