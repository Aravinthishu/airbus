  ...
  return (
    <svg width={14} height={14} viewBox="0 0 14 14">
      ...
      <rect
        ...
        y={5.5}
        width={type === "justify" ? 14 : 8}
        height={1.3}
        fill="#8089A0"
      />
      <rect
        x={type === "right" ? 4 : type === "center" ? 1 : 0}
        y={9}
        width={lineProps[1]}
        height={1.3}
        fill="#8089A0"
...
function TextToolbar() {
  ...
  const divider = (
    <span style={{ width: 1, height: 14, background: "#D8D4CC" }} />
  );
  return (
    <div
      style={{
...
export function TextAreaDemo() {
  ...
  > = {
    default: { bg: "#FAFAFA", border: "#C9CFDA", label: "#3D4759" },
    hover: { bg: "#F5F5F4", border: "#C9CFDA", label: "#3D4759" },
    active: { bg: "#E9EEFC", border: "#2554D6", label: "#3D4759" },
    filled: { bg: "#FAFAFA", border: "#C9CFDA", label: "#3D4759" },
    disabled: { bg: "#F5F5F4", border: "#E4E2DD", label: "#B5B9C2" },
    readonly: { bg: "#FAFAFA", border: "#E4E2DD", label: "#3D4759" },
  };
        ...
        >
          ...
          <textarea
            ...
            style={{
              ...
              fontSize: 13,
              fontFamily: "'DM Sans', sans-serif",
              borderRadius: state === "active" ? "6px" : "6px 6px 2px 2px",
              background: currentStyle.bg,
              border:
                state === "active"
                  ? `2px solid ${currentStyle.border}`
...
}: Omit<SpecRowConfig, 'key' | 'title'> & { isActive?: boolean }) {
  return (
      ...
      <div style={{ borderRadius: '6px 6px 2px 2px', overflow: 'hidden' }}>
        ...
        <textarea
          ...
          style={{
            ...
            borderRadius: isActive ? '6px' : '6px 6px 2px 2px',
...
const SPEC_ROWS: SpecRowConfig[] = [
  { key: 'default', title: 'Default', label: 'Label (Optional)', value: '', placeholder: 'Placeholder', counterText: '0/100', bg: '#FAFAFA', border: '#C9CFDA', borderWidth: 1.5 },
  ...
  { key: 'active', title: 'Active', label: 'Label (Optional)', value: '', placeholder: '', counterText: '0/100', bg: '#E9EEFC', border: '#2554D6', borderWidth: 2, isActive: true },
  { key: 'filled', title: 'Filled', label: 'Label (Optional)', value: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod.', counterText: '30/100', bg: '#FAFAFA', border: '#C9CFDA', borderWidth: 1.5 },
  { key: 'readonly', title: 'Read Only', label: 'Label', value: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod.', footerText: 'Legend', bg: '#FAFAFA', border: '#E4E2DD', borderWidth: 1.5 },
  ...
  { key: 'settings', title: 'Settings', label: 'Label (Optional)', placeholder: 'Placeholder', counterText: '0/100', bg: '#FAFAFA', border: '#C9CFDA', borderWidth: 1.5, showToolbar: true },
];
